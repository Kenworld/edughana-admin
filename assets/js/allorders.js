...
let currentOrder = null; // To hold the order being viewed
...
async function showOrderDetails(orderId, isGuest) {
  ...
  currentOrder = { id: order.id, isGuest: isGuest === "true" }; // Store current order info
